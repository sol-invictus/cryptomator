...
public interface Folder extends Node {
	 ...
	 */
	File file(String path) throws UncheckedIOException;
	 ...
	 */
	Folder folder(String path) throws UncheckedIOException;
	 ...
	 *             one of its parents
	 */
	void createNewFailingIfParentIsMissing() throws UncheckedIOException;
